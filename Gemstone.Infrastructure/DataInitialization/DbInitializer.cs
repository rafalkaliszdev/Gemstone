        ...
        private static void SeedAssignments(EfDbContext context)
        {
            var assignments = new Assignment[]
            {
                new Assignment
                {
                    ...
                    AssignorID = 1,
                    SpecialistID = 5,
                    WorkResultDescription = "machine ready for long journey (fixes, repairs and standard checks)",
                ...
                new Assignment
                {
                    ...
                    AssignorID = 1,
                    SpecialistID = 5,
                    WorkResultDescription = "bring back engine to life",
                    ExpiresOn = RandomDateTime(),
                    ProposedDoneOn = RandomDateTime(),
                ...
                new Assignment
                {
                    ...
                    AssignorID = 1,
                    SpecialistID = 5,
                    WorkResultDescription = "just routine chackes",
                    ExpiresOn = RandomDateTime(),
                    ProposedDoneOn = RandomDateTime(),
